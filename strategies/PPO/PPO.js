...
method.log = function() {
  ...
  console.debug('\t', 'short:', short.toFixed(digits));
  console.debug('\t', 'long:', long.toFixed(digits));
  console.debug('\t', 'macd:', macd.toFixed(digits));
  console.debug('\t', 'macdsignal:', macdSignal.toFixed(digits));
  console.debug('\t', 'machist:', (macd - macdSignal).toFixed(digits));
  console.debug('\t', 'ppo:', result.toFixed(digits));
  console.debug('\t', 'pposignal:', ppoSignal.toFixed(digits));
  console.debug('\t', 'ppohist:', (result - ppoSignal).toFixed(digits));
}
