...
method.log = function() {
  ...
  console.debug('calculated StochRSI properties for candle:');
  console.debug('\t', 'rsi:', this.rsi.toFixed(digits));
	console.debug("StochRSI min:\t\t" + this.lowestRSI.toFixed(digits));
	console.debug("StochRSI max:\t\t" + this.highestRSI.toFixed(digits));
	console.debug("StochRSI Value:\t\t" + this.stochRSI.toFixed(2));
}
